...
public class InvestmentCalculatorExample2 extends API_InvestmentCalculator{
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Scene scene = calc.makeScene(mainPane, 650, 350);
        ...
        calc.pickWindowColor(mainPane, "-fx-background-color: HOTPINK ");
        ...
        calc.setButtons(mainPane,gp,hb,"Future is now!","Book Antiqua", "-fx-background-color: #7109AB");
