...
public class SortSearchAssign_TrostleRobert_v2 {
    ...
    public static void main(String[] args) {
        ...
        //numArray = sort.quickSort(numArray, 0, numArray.length-1);//total time: 6 seconds
        //numArray = sort.quickSort(numArray, 0, 100); takes one second BUT always gives -1 
    ...
    public static int[] getArray()
    {
        ...
        try{
            ...
            line = scan.next();//Scan each line in our string line variable
            
            //arr[count] = Integer.parseInt(line.substring(0,line.indexOf(",")));
            arr[count] = Integer.parseInt(line.substring(line.indexOf(" ")+1,line.lastIndexOf(",")));
